        ...
        <table class="table">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th width="6000px" scope="col">Email</th>
                    <th width="200px" scope="col">Role</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$def -> roles}}</td>
                    <td>
                        <a href="manageuser/edit/{{ $def->id }}" class="badge badge-success" class="d-inline">Edit</a>
                        
                        <form action="manageuser/delete/{{$def->id}}" method="post" class="d-inline">
                        @method('delete')
                        @csrf
